...
import mikhail.shell.video.hosting.data.providers.AndroidUiPreferencesProvider
...
abstract class RepositoriesModule {
    ...
    @Binds
    @Singleton
    abstract fun bindUiPreferencesProvider(provider: AndroidUiPreferencesProvider) : UiPreferencesProvider
}