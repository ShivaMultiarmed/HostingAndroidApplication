...
sealed class ChannelEditingScreenAction {
    ...
    data class ChangeHeader(val editingState: EditingState<String?>) : ChannelEditingScreenAction()
    data class ChangeLogo(val editingState: EditingState<String?>) : ChannelEditingScreenAction()
